        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#services" className="text-[hsl(0,0%,97%,0.6)] hover:text-[hsl(102,81%,60%)] transition-colors">
                  Nettoyage de canapé
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-[hsl(0,0%,97%,0.6)]">
                ...
                <a href="tel:+33600000000" className="hover:text-[hsl(102,81%,60%)] transition-colors">
                  06 XX XX XX XX
                </a>
              </li>
              <li className="flex items-center gap-2 text-[hsl(0,0%,97%,0.6)]">
                <Mail size={16} className="text-[hsl(204,100%,39%)]" />
                <a href="mailto:contact@cleannet63.fr" className="hover:text-[hsl(102,81%,60%)] transition-colors">
                  contact@cleannet63.fr
                </a>
              </li>
        ...
        <div className="pt-8 border-t border-[hsl(0,0%,100%,0.1)]">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a href="#" className="text-sm text-[hsl(0,0%,97%,0.5)] hover:text-[hsl(0,0%,97%,0.8)] transition-colors">
                Mentions légales
              </a>
              <a href="#" className="text-sm text-[hsl(0,0%,97%,0.5)] hover:text-[hsl(0,0%,97%,0.8)] transition-colors">
