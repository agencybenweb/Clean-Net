            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+33600000000" className="text-[hsl(0,0%,97%,0.7)] hover:text-[hsl(102,81%,60%)] transition-colors">
                    06 XX XX XX XX
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:contact@cleannet63.fr" className="text-[hsl(0,0%,97%,0.7)] hover:text-[hsl(102,81%,60%)] transition-colors">
